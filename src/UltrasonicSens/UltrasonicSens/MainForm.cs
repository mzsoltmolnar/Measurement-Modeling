...
namespace UltrasonicSens
{
    ...
    {
        Measurement measMent = new Measurement(); // measurement object - defining the properties of the ultrasonic sensor
        ...
        private void timerSample_Tick(object sender, EventArgs e) // updating the UI
        {
            ...
            if (radioButtonSponge.Checked) material = 2;
            if (radioButtonCeramic.Checked) material = 3;
            if (radioButtonWood.Checked) material = 4;
            if (radioButtonSponge.Checked) material = 5;
